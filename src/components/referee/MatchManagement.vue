            ...
            >
              ...
              <div class="flex items-center space-x-2">
                ...
                <div class="flex flex-col space-y-1">
                  ...
                  <!-- Nouveau bouton pour ouvrir la saisie personnalisée -->
                  <button
...
const currentMatch = computed(() => {
  return matchesStore.currentMatch || matchesStore.matches.find(m => m.id === matchId.value)
})

// Lien de partage
const matchShareLink = computed(() => {
  return `${window.location.origin}/spectate/${currentMatch.value?.code}`
})
